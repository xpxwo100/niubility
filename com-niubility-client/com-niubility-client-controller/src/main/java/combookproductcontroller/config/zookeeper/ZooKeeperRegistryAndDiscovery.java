        ...
        pathChildrenCache.getListenable().addListener(new PathChildrenCacheListener() {
            public void childEvent(CuratorFramework ient, PathChildrenCacheEvent event) throws Exception {
                if(event.getType().equals(PathChildrenCacheEvent.Type.INITIALIZED)){
                    ...
                    System.out.println("添加子节点:"+serviceHashMap);
                    System.out.println("添加子节点:"+serviceMap);
                }else if(event.getType().equals(PathChildrenCacheEvent.Type.CHILD_REMOVED)){
                    System.out.println("删除子节点:"+event.getData().getPath());
                    serviceList = ient.getChildren().forPath(path);
                    buildServiceMap(serviceList);
                    System.out.println("删除子节点 serviceList:"+serviceList);
                    System.out.println("删除子节点 serviceHashMap:"+serviceHashMap);
                    System.out.println("删除子节点 serviceMap:"+serviceMap);
